...
class InlineUpdateDisponibilidadRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'value.required' => 'Debes indicar si la disponibilidad está activa.',
            'value.boolean' => 'El estado de la disponibilidad no es válido.',
        ];
    }
