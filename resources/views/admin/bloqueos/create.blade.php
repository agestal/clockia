...
@section('content_header_extra')
    <div>
        <h1 class="mb-1">Nuevo bloqueo</h1>
        <p class="text-muted mb-0">Crea un bloqueo puntual para un recurso.</p>
    </div>
@stop
...
@section('content_body')
    ...
    <form action="{{ route('admin.bloqueos.store') }}" method="POST" class="js-basic-validation-form" novalidate>
