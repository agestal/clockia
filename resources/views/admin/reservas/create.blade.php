...
@section('content_header_extra')
    <div>
        ...
        <p class="text-muted mb-0">Registra una nueva reserva operativa en el sistema.</p>
    </div>
@stop
...
@section('content_body')
    ...
    <form action="{{ route('admin.reservas.store') }}" method="POST" class="js-basic-validation-form" novalidate>
